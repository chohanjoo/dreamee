...
CREATE TABLE `pastor` (
  `pastor_id` int NOT NULL AUTO_INCREMENT,
  `pastor_name` varchar(45) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`pastor_id`),
  UNIQUE KEY `pastor_name_UNIQUE` (`pastor_name`)
...
INSERT INTO `pastor` VALUES (1,'han'),(17,'김지수'),(10,'박단열'),(9,'박요한'),(11,'백요셉'),(12,'이기호'),(18,'이사무엘'),(15,'이순종'),(13,'이윤기'),(16,'정위로'),(14,'최규진');
